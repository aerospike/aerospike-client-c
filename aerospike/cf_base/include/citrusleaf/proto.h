...
#define CL_PROTO_RESULT_FAIL_INDEX_KEY_NOTFOUND 200 
#define CL_PROTO_RESULT_FAIL_INDEX_TYPE_MISMATCH 201    
#define CL_PROTO_RESULT_FAIL_INDEX_NOTFOUND 202
#define CL_PROTO_RESULT_FAIL_INDEX_OOM 203  
#define CL_PROTO_RESULT_FAIL_INDEX_GENERIC 204  
#define CL_PROTO_RESULT_FAIL_INDEX_EXISTS 205
#define CL_PROTO_RESULT_FAIL_INDEX_SINGLEBIN_NS 206
#define CL_PROTO_RESULT_FAIL_INDEX_UNKNOWN_TYPE 207
#define CL_PROTO_RESULT_FAIL_INDEX_FOUND 208
#define CL_PROTO_RESULT_FAIL_INDEX_NOTREADABLE 209
...
typedef enum {
	...
	CL_PARTICLE_TYPE_ERLANG_BLOB = 11,
	CL_PARTICLE_TYPE_APPEND = 12,
	CL_PARTICLE_TYPE_LUA_BLOB = 13,
	CL_PARTICLE_TYPE_JSON_BLOB = 14,
	CL_PARTICLE_TYPE_MAX = 15
} cl_particle_type;
...
#define CL_MSG_FIELD_TYPE_SPROC_MAP				32
#define CL_MSG_FIELD_TYPE_SPROC_REDUCE			33
#define CL_MSG_FIELD_TYPE_SPROC_FINALIZE		34
#define CL_MSG_FIELD_TYPE_SPROC_MAP_ARG			35
#define CL_MSG_FIELD_TYPE_SPROC_REDUCE_ARG		36
#define CL_MSG_FIELD_TYPE_SPROC_FINALIZE_ARG	37
