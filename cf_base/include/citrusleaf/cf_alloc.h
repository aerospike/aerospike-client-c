...
#define cf_rc_count(addr) cf_client_rc_count(addr)
...
extern cf_atomic_int_t cf_client_rc_release(void *addr, bool autofree);
#define cf_rc_release(a) (cf_client_rc_release((a), false))
#define cf_rc_releaseandfree(a) (cf_client_rc_release((a), true))
