...
#include "evcitrusleaf-internal.h"
...
typedef struct cl_cluster_node_s {
	...
	int			dun_count;  // number of sequential dunns
	...
	uint64_t partition_last_req_ms;
...
extern int cl_lookup(char *hostname, short port, cl_lookup_async_fn cb, void *udata);

// Cluster calls
extern cl_cluster_node *cl_cluster_node_get(evcitrusleaf_cluster *asc, char *ns, cf_digest *d, bool write);  // get node from cluster
...
extern void cl_partition_table_remove_node( evcitrusleaf_cluster *asc, cl_cluster_node *node );
extern void cl_partition_table_destroy_all(evcitrusleaf_cluster *asc);
extern void cl_partition_table_set( evcitrusleaf_cluster *asc, cl_cluster_node *node, char *ns, cl_partition_id pid, bool write);
extern cl_cluster_node *cl_partition_table_get( evcitrusleaf_cluster *asc, char *ns, cl_partition_id pid, bool write);
