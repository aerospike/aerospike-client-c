...
extern cl_rv aerospike_lstack_push_with_transform(
        cl_cluster * asc,
        const char * namespace,
        const char * set,
        const cl_object * o_keyp,
...
extern cl_rv aerospike_lstack_push_with_transform_with_keystring(
        cl_cluster * asc,
        const char * namespace,
        const char * set,
        const char * keystr,
...
extern as_result  * aerospike_lstack_peek(
        cl_cluster * asc,
        const char * namespace,
        const char * set,
        const cl_object * o_keyp,
...
extern as_result * aerospike_lstack_peek_with_keystring(
        cl_cluster * asc,
        const char * namespace,
        const char * set,
        const char * keystr,
...
extern as_result * aerospike_lstack_peek_with_transform(
        cl_cluster * asc,
        const char * namespace,
        const char * set,
        const cl_object * o_keyp,
...
extern as_result * aerospike_lstack_peek_with_transform_with_keystring(
        cl_cluster * asc,
        const char * namespace,
        const char * set,
        const char * keystr,
