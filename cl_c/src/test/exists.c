...
int main(int argc, char ** argv) {
    ...
    rc = citrusleaf_exists_key(cluster, n, s, &key, bins, nbins, TIMEOUT, &gen);
...
static int usage(const char * program) {
    ...
    fprintf(stderr, "\n");
    fprintf(stderr, "Test for the existence of a key. If the exit status is 0, then it completed successfully.\n");
    fprintf(stderr, "\n");
