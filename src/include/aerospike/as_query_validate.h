...
as_query_validate_begin(
	as_error* err, struct as_node_s* node, const as_namespace ns, uint64_t* cluster_key
	);
...
as_status
as_query_validate(
	as_error* err, struct as_node_s* node, const as_namespace ns, uint64_t expected_key
	);
 ...
 */
as_status
as_query_validate_begin_async(struct as_event_executor* executor, const as_namespace ns, as_error* err);
 ...
 */
void
as_query_validate_end_async(struct as_event_command* cmd);
