...
TEST(map_key_in_list_select, "Test KEY_IN_LIST with select_by_path")
{
	...
	as_cdt_ctx_add_map_keys_in(&ctx1, (as_list*)&user_keys);
...
test_dump_record(rec, true);
	...
	as_cdt_ctx_add_map_keys_in(&ctx2, (as_list*)&user_keys2);
	...
	as_cdt_ctx_add_map_keys_in(&ctx3, (as_list*)&prod_keys);
	...
	as_cdt_ctx_add_map_keys_in(&ctx4, (as_list*)&top_keys);
...
TEST(map_key_in_list_modify, "Test KEY_IN_LIST with modify_by_path")
{
	...
	as_cdt_ctx_add_map_keys_in(&ctx1, (as_list*)&warehouse_keys1);
	...
	as_cdt_ctx_add_map_keys_in(&ctx2, (as_list*)&warehouse_keys2);
	...
	as_cdt_ctx_add_map_keys_in(&ctx2, (as_list*)&item_keys);
	...
	as_cdt_ctx_add_map_keys_in(&ctx3, (as_list*)&warehouse_keys3);
	...
	as_cdt_ctx_add_map_keys_in(&ctx4, (as_list*)&warehouse_keys4);
